  ...
  return (
    <main className="min-h-screen bg-elite-quartz flex items-center justify-center py-20 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl p-8 shadow-xl border border-elite-navy/10">
        ...
        <p className="text-elite-navy/70 mb-8">Faça login para acessar o dashboard</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-elite-navy mb-2">
              Senha
            </label>
            <input
              type="password"
