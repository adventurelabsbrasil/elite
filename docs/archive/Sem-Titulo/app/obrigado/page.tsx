      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-elite-navy/70">
            Sua vaga no webinar está garantida. Você receberá todas as informações por email.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 border border-elite-navy/10 shadow-lg space-y-6">
          <div className="space-y-4">
            ...
            <ul className="text-left space-y-3 text-elite-navy/70">
              <li className="flex items-start gap-3">
                ...
                <span>Verifique seu email (incluindo spam) para receber o link de acesso</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-elite-flow flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-elite-flow flex-shrink-0 mt-0.5" />
                <span>Entre no grupo VIP no WhatsApp para networking e atualizações</span>
              </li>
            </ul>
          </div>
          ...
          <div className="pt-6 border-t border-elite-navy/10">
            <a
              ...
              className="inline-flex items-center gap-2 bg-elite-glow hover:bg-[#E04508] text-white font-semibold py-3 px-6 rounded-lg transition-colors"
            >
