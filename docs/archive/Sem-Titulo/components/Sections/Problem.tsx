...
const problems = [
  {
    ...
    description: 'O investimento em tráfego sobe, mas o número de visitas não acompanha.',
  },
  {
    icon: TrendingDown,
    title: 'Leads baratos que não convertem',
    description: 'Corretores reclamando que os leads são ruins. Lead barato é o maior prejuízo.',
  },
  {
    icon: Users,
    title: 'Falta de previsibilidade de receita',
    description: 'Não sabe qual anúncio trouxe o cliente que comprou. Sem visibilidade do funil.',
  },
  {
    icon: XCircle,
    title: 'Desalinhamento entre Marketing e Vendas',
    description: 'Marketing foca em lead barato, Vendas reclama da baixa qualidade. Times desalinhados.',
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-elite-navy/70 max-w-3xl mx-auto">
            Problemas comuns que impedem loteadoras de alcançar o esgotamento do VGV
          </p>
        </div>
