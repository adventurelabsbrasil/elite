            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-lg text-elite-navy/80 leading-relaxed">
                  é o founder da <strong className="text-elite-navy">Adventure Labs</strong> e o nome por trás de estratégias que moldaram o novo padrão de lançamentos imobiliários. Com um perfil raro que une a visão criativa do Design à precisão técnica do Martech, ele construiu uma trajetória de 10 anos dominando dados, tecnologia e comportamento de consumo.
                </p>
                <p className="text-lg text-elite-navy/80 leading-relaxed">
                  Sua experiência consolidada na <strong className="text-elite-navy">Young Empreendimentos</strong> permitiu o desenvolvimento de uma metodologia validada no "campo de batalha". Rodrigo não entrega apenas tráfego; ele entrega inteligência de vendas que transforma investimentos em VGV esgotado, garantindo que o dono da loteadora tenha controle absoluto sobre cada real gerenciado.
                </p>
              </div>
