...
const notForWho = 'Este programa não é para donos de loteadoras que buscam "atalhos mágicos" ou sorte, que não estão dispostos a integrar tecnologia (Martech) ao comercial e que preferem continuar tomando decisões milionárias baseadas apenas no "feeling", ignorando o que os dados do funil dizem.'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {forWho.map((item, index) => {
              // Extrair a parte em negrito (antes de "Você")
              ...
              return (
                ...
                >
                  ...
                  <p className="text-elite-navy/80 leading-relaxed text-lg">
                    {boldPart && <strong className="text-elite-navy">{boldPart} </strong>}
                    {restPart}
                  </p>
                </div>
              )
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-start gap-4 bg-red-50 rounded-xl p-6 border border-red-200">
            ...
            <p className="text-elite-navy/80 leading-relaxed text-lg">
              <strong className="text-elite-navy">Este programa não é para </strong>
